...
![Qualitative Comparison](./assets/fig3_qualitative_comparison.png)

**Qualitative comparison** of different cartoon inbetweening methods. From left to right, the figure shows the starting frame, selected intermediate frames, and the ending frame generated by different methods. Our method produces more temporally coherent motion while preserving finer structural details and cartoon style consistency.
